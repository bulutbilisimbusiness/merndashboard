			...
			<div className="max-w-2xl mx-auto p-3 text-center">
				<div>
					...
					<div className="text-md text-gray-500 flex flex-col gap-6">
						<p>
							Welcome to Erhan&apos;s Blog! This blog was created by Erhan Bulut
							as a personal project to share his thoughts and ideas with the
							world. Erhan is a passionate developer who loves to write about
						...
						<p>
							...
							programming languages. Erhan is always learning and exploring new
